            ...
            child: Accordion(
              ...
              children: [
                AccordionSection(
                  ...
                  isOpen: false,
                  header: Text('Pourquoi choisir l’application Oremus ?',
                ...
                AccordionSection(
                  ...
                  headerPadding: const EdgeInsets.symmetric(
                      vertical: 8, horizontal: 14),
                  isOpen: false,
                  header: Text('Comment utiliser l’application Oremus ?',
                    style: TextStyles.montserratSemiBold(
                        textSize: TextSizes.sixteen, textColor: colorWhite),),
                  content: Text(
                ...
                AccordionSection(
                  ...
                  headerPadding: const EdgeInsets.symmetric(
                      vertical: 8, horizontal: 14),
                  isOpen: false,
                  header: Text('Qui est l’auteur de l’application Orémus ?',
                    style: TextStyles.montserratSemiBold(
                        textSize: TextSizes.sixteen, textColor: colorWhite),),
                  content: Text(
                ...
                AccordionSection(
                  ...
                  headerPadding: const EdgeInsets.symmetric(
                      vertical: 8, horizontal: 14),
                  isOpen: false,
                  header: Text('Comment est financée l’application Orémus ?',
                    style: TextStyles.montserratSemiBold(
                        textSize: TextSizes.sixteen, textColor: colorWhite),),
                  content: Text(
                ...
                AccordionSection(
                  ...
                  headerPadding: const EdgeInsets.symmetric(
                      vertical: 8, horizontal: 14),
                  isOpen: false,
                  header: Text('Comment soutenir Orémus ?',
                    style: TextStyles.montserratSemiBold(
                        textSize: TextSizes.sixteen, textColor: colorWhite),),
                  content: RichText(
