...
class ElegantPlayer extends StatelessWidget {
  const ElegantPlayer({Key? key, required this.audioService, required this.controller}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: _buildPlayerContent(
        ...
        controller,
        progressBarHeight: 4,
        progressBarRadius: 25,
        bgColor: theme.inactiveColor.withValues(alpha: 0.2),
        bufferedColor: theme.inactiveColor.withValues(alpha: 0.6),
        progressColor: theme.activeColor,
        titleColor: theme.crossColor,
        subtitleColor: Color.lerp(theme.crossColor, Colors.grey[600]!, 0.5)!,
        iconColor: theme.activeColor,
        closeIconColor: Color.lerp(theme.crossColor, Colors.grey[600]!, 0.7)!,
        contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
        addSeparator: false,
        useElevatedControls: true,
        controlIconSize: 26,
      ),
    );
  }
