...
class ClassicPlayer extends StatelessWidget {
  const ClassicPlayer({Key? key, required this.audioService, required this.controller}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: _buildPlayerContent(
          ...
          bgColor: theme.inactiveColor.withValues(alpha: 0.3),
          bufferedColor: theme.inactiveColor,
