                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: getColor(
                                      _.donationSelected.value.status?.code),
                                )),
                            child: Icon(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      getCustomDate(_.donationSelected.value.createdAt ?? ''),
                                      textAlign: TextAlign.center,
                                    ...
                                    Separators.minimunVertical(),
                                    Text(
                                      '${_.donationSelected.value.amount.toString().split('.').first.amountFormat()} FCFA',
                                      textAlign: TextAlign.center,
                                      style: TextStyles.montserratSemiBold(
                                        textSize: TextSizes.sixteen,
                                        textColor: colorBlack,
