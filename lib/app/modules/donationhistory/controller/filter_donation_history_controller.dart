...
class FilterDonationHistoryController extends GetxController {
  final DonationRepository massRequestRepository;
  ...
  doResetFilter() {
    ...
    canDoApplyAction();
    hideKeyboard();
    Get.delete<FilterDonationHistoryController>(force: true);
  }
